...
<body>
	...
	<!-- registrar SECTION -->
	<form method="POST" action="modificar-producto.html">
    Antiguo Nombre del Producto:  <input class="form-wt" type="text" name="Nombre" value="Nombre Antiguo"><br>
    Nuevo Nombre del Producto:  <input class="form-wt" type="text" name="Nombre" value="Nombre Nuevo"><br>
		Marca:  <input class="form-wt" type="text" name="Marca" value="Marca"><br>
		Tamaño:  <input class="form-wt" type="number" name="Tamaño" value="5"><br>
		Sistema Operativo:  		<select name="OS">
    			<option value="Android">Android</option>
    			<option value="IOS">IOS</option>
    		</select>
        <br>
		Descripción Breve:  <input class="form-wt" type="text" name="desc_Corta" value="desc_Corta"><br>
		Descripción Larga:  <input class="form-wt" type="text" name="desc_Larga" value="desc_Larga"><br>
		Precio:  <input class="form-wt" type="number" name="Precio" value="100"><br>
		Cantidad: <input class="form-wt" type="number" name="Cantidad" value="1">
		<br>
